...
//* $Restricted = array('face-world.ru' => 'Ссылка, по которой Вы попытались перейти, может вести на сайт, который был создан с целью обмана пользователей MixNet и получения за счет этого прибыли *//

//* Не в коем случае не вводите свои данные от учетной записи MixNet на данном сайте.'); *//
